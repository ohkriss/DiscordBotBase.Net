...
namespace DiscordBotBase.Attributes
{
    ...
    public sealed class CooldownAttribute : PreconditionAttribute
    {
        ...
        public override async Task<PreconditionResult> CheckPermissionsAsync(ICommandContext context, CommandInfo command, IServiceProvider services)
        {
            ...
            var bid = this.GetBucketId(context, out var usr, out var chn, out var gld);
            ...
            if (await bucket.DecrementUseAsync())
                return await Task.FromResult(PreconditionResult.FromSuccess());
            else
                return await Task.FromResult(PreconditionResult.FromError(ErrorMessage + $" [{this.GetRemainingCooldown(context).TotalSeconds}]"));
        }
        ...
        public CommandCooldownBucket GetBucket(ICommandContext ctx)
        {
        ...
        public TimeSpan GetRemainingCooldown(ICommandContext ctx)
        {
        ...
        private string GetBucketId(ICommandContext ctx, out ulong userId, out ulong channelId, out ulong guildId)
        {
            userId = 0ul;
